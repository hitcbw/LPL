import libs.models.graph.DeST.dest_tools as tools
import matplotlib 
matplotlib.use('Agg') 
...
class Graph:
    def __init__(self, labeling_mode='spatial', layout='MCFS-22'):
        ...
        self.get_edge(layout) #拿到边，包括自己，in和out
    ...
    def get_edge(self, layout):
        if layout == 'MCFS-22' or layout == 'MCFS-130':
            ...
            self.num_node = 19
            self.self_link  = [(i, i) for i in range(self.num_node)]
            self.inward  = [(1, 0), (2, 1), (3, 2), (4, 3), (5, 0), (6, 5), (7, 6), (8, 7), (9, 0), (10, 9), (11, 9), (12,11), (13,12), (14,13), (15,9), (16,15), (17,16), (18,17)]
            self.outward  = [(j, i) for (i, j) in self.inward]
            self.neighbor = self.inward + self.outward
        elif layout == 'TCG':
            self.num_node = 17
